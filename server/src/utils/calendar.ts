...
export function getWeekBounds(value: string): { weekStart: string; weekEnd: string } {
  const date = parseCalendarDate(value);
...
export function getTodayInTimeZone(instant: Date, timeZone?: string): string {
...
export function isConsumptionDateAllowed(
